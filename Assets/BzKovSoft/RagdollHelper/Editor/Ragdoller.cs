...
namespace BzKovSoft.RagdollHelper.Editor
{
	...
	sealed class Ragdoller
	{
		...
		public void ApplyRagdoll(float totalMass, RagdollProperties ragdollProperties)
		{
			...
			// Add by zeyu
			if (ragdollProperties.poseType==PoseType.Stand)
			{
				...
				_pelvis.transform.gameObject.GetComponent<Rigidbody>().constraints = constraints;
				_leftHip.transform.gameObject.GetComponent<Rigidbody>().constraints = constraints;
				_leftKnee.transform.gameObject.GetComponent<Rigidbody>().constraints = constraints;
				_rightHip.transform.gameObject.GetComponent<Rigidbody>().constraints = constraints;
				_rightKnee.transform.gameObject.GetComponent<Rigidbody>().constraints = constraints;
				_chest.transform.gameObject.GetComponent<Rigidbody>().constraints = constraints;
				_head.transform.gameObject.GetComponent<Rigidbody>().constraints = constraints;
			}
			else if(ragdollProperties.poseType==PoseType.Sit)
			{
				var constraints = RigidbodyConstraints.FreezeRotationX | RigidbodyConstraints.FreezeRotationY | RigidbodyConstraints.FreezeRotationZ;
				_pelvis.transform.gameObject.GetComponent<Rigidbody>().constraints = constraints;
				_chest.transform.gameObject.GetComponent<Rigidbody>().constraints = constraints;
